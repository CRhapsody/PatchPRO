...
def test_trades_adv_acc(net_name, radius_bit, repair_number,device):
    ...
    # load data
    adv_datas,adv_labels = torch.load(f'./data/tiny_imagenet/test_adv_{net_name}_{radius_bit}.pt',map_location=device)
    # dataset
    ...
    # For net: resnet152, radius: 2,repair_number: 500, PatchRepair:0.3931, original:0.0
    # For net: resnet152, radius: 2,repair_number: 1000, PatchRepair:0.3943, original:0.0
    # For net: resnet152, radius: 4,repair_number: 500, PatchRepair:0.3271, original:0.0
    # For net: resnet152, radius: 4,repair_number: 1000, PatchRepair:0.3274, original:0.0
    # For net: wide_resnet101_2, radius: 2,repair_number: 500, PatchRepair:0.3065, original:0.0
    # For net: wide_resnet101_2, radius: 2,repair_number: 1000, PatchRepair:0.3065, original:0.0
    # For net: wide_resnet101_2, radius: 4,repair_number: 500, PatchRepair:0.2325, original:0.0
    # For net: wide_resnet101_2, radius: 4,repair_number: 1000, PatchRepair:0.2302, original:0.0

    if net_name == 'resnet152' and radius_bit == 2 and repair_number == 500:
    ...
    if not os.path.exists(f'./results/tiny_imagenet/trades'):
        os.mkdir(f'./results/tiny_imagenet/trades')
    with open(f'./results/tiny_imagenet/trades/adv_acc.txt','a') as f:
        f.write(f"{net_name} {radius_bit} {repair_number} adv_acc:{adv_correct/len(adv_loader.dataset)}\n")
    ...
    for radius in [2,4]:
        for data in [500,1000]:
            ...
            for net_name in ['resnet152','wide_resnet101_2']:
                ...
                test_trades_adv_acc(net_name,radius,data,device)
